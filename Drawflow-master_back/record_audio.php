    ...
    <div id="tab1" class="show">
      <form class="get-input-form" id="get_record_audio">
        <div class="form-group  IVR-Menu  ">
          ...
          <input name="Name" type="text" value="Record Audio_4" placeholder="Enter value"
                  ...
                  <li class="steps-item">
                    ...
                    <div>
                      <div class="card auto-width-tabs">
                        <div class="card-body">
                          <div class="tabs_field-label">
                              ...
                              <ul role="tablist" class="nav nav-pills">
                                <li role="presentation" class="nav-item">
                                  <a role="tab" aria-selected="true" aria-setsize="2" aria-posinset="1"
                                    href="#speaktext" target="_self" class="nav-link active">Speak Text</a>
                                </li>
                                <li role="presentation" class="nav-item">
                            ...
                            <div class="tab-content">
                              <div id="speaktext" role="speak_text1" aria-hidden="false" class="tab-pane active">
                                <div class="form-group">
                                  <div class="bv-no-focus-ring">
                        ...
                        <div id="uploadfile" role="upload_file1" aria-hidden="true" class="tab-pane "
                          style="display: none;">
  ...
  <div  class="bv-no-focus-ring"><label id="action-label" class="right-label _field-label">Settings</label>
    <div>
      <div class="form-group mb-0 ml-2">
        ...
        <div  class="bv-no-focus-ring">
          <label id="timeout-label" class="_field-label"> End recording on silence</label><input id="timeout"
            name="voicemail_timeout" type="number" class="inline small-input _field-value form-control form-control-sm"
            data-vv-id="_v1xslju1x" aria-required="false" aria-invalid="false">
    ...
    <div class="form-group mb-0 ml-2">
      ...
      <div class="bv-no-focus-ring">
        <label id="timeout-label" class="_field-label"> Voicemail length</label><input id="timeout"
          name="voicemail_length" type="number" class="inline small-input _field-value form-control form-control-sm"
...
<div class="form-group mb-0 ml-2">
  ...
  <div class="bv-no-focus-ring">
    ...
    <label class="_field-label">End recording on digit</label><select name="end_recording"
      class="inline _field-value custom-select custom-select-sm" placeholder="">
      <option value="*">*</option>
              ...
              <div class="card-body">
                <div  class="input-group flex">
                  ...
                  <div class="_field-value" aria-required="false" aria-invalid="false">
                    <div class="complete-box">
                      <input id="text" autocomplete="off" value="<?php if(isset($event_callback_url)){echo $event_callback_url; } ?>"  placeholder="Enter a Url" rows="1" name="event(0)"
