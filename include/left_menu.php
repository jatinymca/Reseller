 <div class="sidebar-container">
   <div class="sidemenu-container navbar-collapse collapse fixed-menu">
     <div id="remove-scroll" class="left-sidemenu">
       <ul id="sub-menu" class="sub-menu sidemenu page-header-fixed slimscroll-style" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
         ...
         <li class="nav-item 
         <?php if(isset($menu_name) && $menu_name=='USER'){ echo 'open'; } ?>">
         ...
         <ul class="sub-menu" <?php if(isset($menu_name) && $menu_name=='USER'){ echo 'style="display: block;"'; } ?>>
           <li class="nav-item">
             <a href="javascript:void(0);" class="nav-link nav-toggle sub_parent">
               <!-- <img alt="logo" class="icom_img" src="assets/img/manage.png"> --> Manage <span class="arrow"></span>
             </a>
             <ul id="sub-menu" class="sub-menu 
             <?php if(isset($sub_menu_name) && $sub_menu_name=='manage'){ echo 'open'; } ?>" <?php if(isset($sub_menu_name) && $sub_menu_name=='manage'){ echo 'style="display: block;"'; } ?>>
             <li class="nav-item">
         ...
         <!-- <li class="nav-item"> <?php
             ...
             <li class="nav-item">
               <a href="javascript:void(0);" class="nav-link nav-toggle sub_parent">
                 <i class="fa fa-university"></i> Campaign <span class="arrow"></span>
               </a>
               <ul id="sub-menu" class="sub-menu  
								<?php if(isset($sub_menu_name) && $sub_menu_name=='campaign'){ echo 'open'; } ?>" <?php if(isset($sub_menu_name) && $sub_menu_name=='campaign'){ echo 'style="display: block;"'; } ?>>
                 <li class="nav-item ">
             ...
             <li class="nav-item">
               <a href="javascript:void(0);" class="nav-link nav-toggle sub_parent">
                 <i class="fa fa-flag"></i> Report <span class="arrow"></span>
               </a>
               <ul id="sub-menu" class="sub-menu  
								<?php if(isset($sub_menu_name) && $sub_menu_name=='Report'){ echo 'open'; } ?>" <?php if(isset($sub_menu_name) && $sub_menu_name=='Report'){ echo 'style="display: block;"'; } ?>>
                 <li class="nav-item ">
             ...
             <li class="nav-item">
               <a href="javascript:void(0);" class="nav-link nav-toggle sub_parent">
                 <i class="fa fa-university"></i> Request <span class="arrow"></span>
               </a>
               <ul class="sub-menu  
								<?php if(isset($sub_menu_name) && $sub_menu_name=='Request'){ echo 'open'; } ?>" <?php if(isset($sub_menu_name) && $sub_menu_name=='Request'){ echo 'style="display: block;"'; } ?>>
                 <li class="nav-item ">
             ...
             <li class="nav-item">
               <a href="javascript:void(0);" class="nav-link nav-toggle sub_parent">
                 <i class="fa fa-university"></i> Approvals <span class="arrow"></span>
               </a>
               <ul id="sub-menu" class="sub-menu  
								<?php if(isset($sub_menu_name) && $sub_menu_name=='Approvals'){ echo 'open'; } ?>" <?php if(isset($sub_menu_name) && $sub_menu_name=='Approvals'){ echo 'style="display: block;"'; } ?>>
                 <li class="nav-item">
             ...
             <li class="nav-item">
               <a href="javascript:void(0);" class="nav-link nav-toggle sub_parent">
                 <i class="fa fa-address-book"></i> PhoneBook <span class="arrow"></span>
               </a>
               <ul id="sub-menu" class="sub-menu  
								<?php if(isset($sub_menu_name) && $sub_menu_name=='PhoneBook'){ echo 'open'; } ?>" <?php if(isset($sub_menu_name) && $sub_menu_name=='PhoneBook'){ echo 'style="display: block;"'; } ?>>
                 <li class="nav-item ">
             ...
             <li class="nav-item">
               <a href="javascript:void(0);" class="nav-link nav-toggle sub_parent">
                 <i class="fa fa-university"></i> My Account <span class="arrow"></span>
               </a>
               <ul id="sub-menu" class="sub-menu  
								<?php if(isset($sub_menu_name) && $sub_menu_name=='Account'){ echo 'open'; } ?>" <?php if(isset($sub_menu_name) && $sub_menu_name=='Account'){ echo 'style="display: block;"'; } ?>>
                 <li class="nav-item">
             ...
             <li class="nav-item">
               <a href="javascript:void(0);" class="nav-link nav-toggle sub_parent">
                 <i class="fa fa-sliders"></i> Manage <span class="arrow"></span>
               </a>
               <ul id="sub-menu" class="sub-menu  
								<?php if(isset($sub_menu_name) && $sub_menu_name=='Manage'){ echo 'open'; } ?>" <?php if(isset($sub_menu_name) && $sub_menu_name=='Manage'){ echo 'style="display: block;"'; } ?>>
                 <li class="nav-item">
        ...
        <!--  <li class="nav-item">
           ...
           <ul id="sub-menu" class="sub-menu" <?php if(isset($menu_name) && $menu_name=='Email'){ echo 'style="display: block;"'; } ?>>
             ...
             <li class="nav-item">
               ...
               <ul class="sub-menu  
                 ...
                 <li class="nav-item ">
                   ...
                   <li class="nav-item "><a href="?page_name=email_request_templatedemo" class="nav-link"><i class="fa fa-file-pdf-o"></i> Request Template Demo</a></li>  
               </ul>
             </li>
             <li class="nav-item">
               <a href="javascript:void(0);" class="nav-link nav-toggle sub_parent">
                 <i class="fa fa-address-book"></i> EmailBook <span class="arrow"></span>
               </a>
               <ul id="sub-menu" class="sub-menu  
								<?php if(isset($sub_menu_name) && $sub_menu_name=='EmailBook'){ echo 'open'; } ?>" <?php if(isset($sub_menu_name) && $sub_menu_name=='EmailBook'){ echo 'style="display: block;"'; } ?>>
                 <li class="nav-item ">
             ...
             <li class="nav-item">
               <a href="javascript:void(0);" class="nav-link nav-toggle sub_parent">
                 <i class="fa fa-history"></i> Email Histroy <span class="arrow"></span>
               </a>
               <ul id="sub-menu" class="sub-menu  
								<?php if(isset($sub_menu_name) && $sub_menu_name=='EmailHistory'){ echo 'open'; } ?>" <?php if(isset($sub_menu_name) && $sub_menu_name=='EmailHistory'){ echo 'style="display: block;"'; } ?>>
                 <li class="nav-item ">
         ...
         <!--============                  OBD ========================================================================================================= -->
         <li class="nav-item 
         <?php if(isset($menu_name) && $menu_name=='OBD'){ echo 'open'; } ?>"> <?php 
     ...
     ?> <ul id="sub-menu" class="sub-menu" <?php if(isset($menu_name) && $menu_name=='OBD'){ echo 'style="display: block;"'; } ?>>
       ...
       <li class="nav-item" <?php if(isset($menu_name) && $menu_name=='OBD'){ echo 'open'; } ?>>
         <a href="javascript:void(0);" class="nav-link nav-toggle sub_parent">
           <i class="fa fa-university"></i> Report <span class="arrow"></span>
         </a>
         <ul class="sub-menu  
         <?php if(isset($sub_menu_name) && $sub_menu_name=='Report'){ echo 'open'; } ?>" <?php if(isset($sub_menu_name) && $sub_menu_name=='Report'){ echo 'style="display: block;"'; } ?>>
         <li class="nav-item">
           ...
           <li class="nav-item ">
             ...
             <li class="nav-item">
               <a href="javascript:void(0);" class="nav-link nav-toggle sub_parent">
                 <i class="fa fa-university"></i> Announcement <span class="arrow"></span>
               </a>
               <ul class="sub-menu">
                 <li class="nav-item">
               ...
               <li class="nav-item">
                 <a href="javascript:void(0);" class="nav-link nav-toggle sub_parent">
                   <i class="fa fa-university"></i> Phone Book <span class="arrow"></span>
                 </a>
                 <ul class="sub-menu  
                 <?php if(isset($sub_menu_name) && $sub_menu_name=='contacts'){ echo 'open'; } ?>" <?php if(isset($sub_menu_name) && $sub_menu_name=='contacts'){ echo 'style="display: block;"'; } ?>>
                 <li class="nav-item">
                 ...
                 <li class="nav-item">
                   <a href="javascript:void(0);" class="nav-link nav-toggle sub_parent">
                     <i class="fa fa-university"></i> Manage <span class="arrow"></span>
                   </a>
                   <ul class="sub-menu">
                     <li class="nav-item">
          ...
          <!--    <li class="nav-item">
               <a href="javascript:void(0);" class="nav-link nav-toggle sub_parent">
                 <i class="fa fa-university"></i> Reschedule <span class="arrow"></span>
               </a>
               <ul class="sub-menu">
                 <li class="nav-item">
                   <a href="?page_name=Reschedule" class="nav-link">
                     <i class="fa fa-file-pdf-o"></i> Reschedule</a>
                 </li> 
               </ul>
             </li> -->
           </ul>
         ...
         <li class="nav-item 
         <?php if(isset($menu_name) && $menu_name=='IVRS'){ echo 'open'; } ?>">
         <li class="nav-item"> <?php 
     ...
     ?>  
         <ul class="sub-menu">
           <li class="nav-item">
             <a href="?page_name=ivr" class="nav-link">
               <i class="fa fa-file-pdf-o"></i>IVRS </a>
             </li> 
                 <li class="nav-item">
                   <a href="?page_name=ivr_report" class="nav-link">
                     <i class="fa fa-file-pdf-o"></i>Report </a>
                   </li>
                   <li class="nav-item">
                     <a href="?page_name=missed_call_report" class="nav-link">
                      <i class="fa fa-file-pdf-o"></i> Missed Report</a>
                    </li>
                  </ul>
                </li> 
       ...
       <li class="nav-item">
        ...
        <!--  <li class="nav-item 
					<?php if(isset($menu_name) && $menu_name=='Request'){ echo 'open'; } ?>">
           <a href="javascript:void(0);" class="nav-link nav-toggle">
