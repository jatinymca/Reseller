...
<div class="row">
   <div class="col-md-12 col-sm-12">
      <div class="card card-box">
         <div class="card-head">
            <header>Rejected Template List</header>
            <ol class="breadcrumb page-breadcrumb pull-right" style="font-size: 12px;">
               ...
               <li><a class="parent-item" href="" style="color:#fff">Approval</a>&nbsp;<i class="fa fa-angle-right"></i>
               </li>
               <li><a class="parent-item" href="" style="color:#fff">Rejected Template</a>
               </li>
            </ol>
         </div>
        <div class="card-body">
            <div class="row">
               <div class="col-md-12">
                  <div class="row">
                     <div class="col-sm-12" style="height: auto; overflow-y: scroll; white-space: nowrap;">
                        ...
                        <table class="table table-striped" id="example4">
                           ...
                           <tbody id="fetch_reject_sms_template">
                           </tbody>
                        </table>
                     </div>
                  </div>
